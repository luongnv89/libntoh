...
compile: 
	gcc -g -o test ex3.c -lntoh -lpcap -lpthread
Run test & expected result:
./test -f ../data-set/googlefr-tcp-in-order.pcap 
[INFO] (ex3.c:61) libntoh version: 0.4a
[INFO] (ex3.c:166) New stream is added from:  192.168.0.45:48487
[INFO] (ex3.c:167) to: 64.233.166.94:80
[INFO] (ex3.c:27) Something is happening here..
[INFO] (ex3.c:27) Something is happening here..
[INFO] (ex3.c:27) Something is happening here..
[INFO] (ex3.c:27) Something is happening here..
[INFO] (ex3.c:27) Something is happening here..
